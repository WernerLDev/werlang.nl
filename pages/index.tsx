    ...
    <>
      ...
      <main>
        <Header>
          <div className={`container p-5`}>
            <div className="col-12 py-2 fgcolor-light text-center">
              <h1>Hi, I&apos;m Werner</h1>
              <span>
                I specialize in building web applications and online experiences
        ...
        >
          ...
          <p>
            I implemented the websocket protocol in TypeScript to learn more
            about how the protocol works. It contains the initial handshake and
          ...
          <p>
            I needed a simple way to fetch subtitles so I created a simple
